...
releases: "0.24.0": {
	...
	known_issues: [
		...
		"""
			...
			""",
		"""
			Supplying an empty string (`""`) for options that take a field name stopped started
			panicking in 0.24.0 rather than disabling the option as it previously did. Fixed in
			0.24.2.
			""",
		"""
